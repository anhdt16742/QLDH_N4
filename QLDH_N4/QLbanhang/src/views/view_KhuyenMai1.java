 ...
 * @author Admin
 */
public class view_KhuyenMai1 extends javax.swing.JPanel {
    ...
    private List<KhuyenMai> lkm = new ArrayList<>();
    ...
    public view_KhuyenMai1() {
        ...
        lkm = new KhuyenmaiService().getlist();
...
//        dsKM = khuyenmaiService.getlist();
        for (KhuyenMai x : khuyenmaiService.getlist()) {
            dsKM.add(x);
        }

        for (KhuyenMai x : dsKM) {

            // load table , dong thoi cap nhat khuyen mai 
        ...
        if (new KhuyenmaiService().capNhatTrangThaiKhuyenMai()) {
            JOptionPane.showMessageDialog(panelBorder1, "Cập nhật thành công");
        }
    }
    ...
    private void initComponents() {
        ...
        btn_tkt.setBackground(new java.awt.Color(51, 204, 255));
        btn_tkt.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btn_tkt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/search_24px.png"))); // NOI18N
        btn_tkt.setText("Tìm kiếm theo tên");
        btn_tkt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_tktActionPerformed(evt);
            }
        });
        add(btn_tkt, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 310, -1, -1));
